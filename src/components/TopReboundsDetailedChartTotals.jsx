...
const TopReboundsDetailedChartTotals = ({ topTRB }) => {
  const playerNames = topTRB.map((player) => player.player_name);
  ...
  const data = {
    ...
    datasets: [
      ...
      {
        label: "Total Offensive Rebounds",
        data: playerORB,
      ...
      {
        label: "Total Defensive Rebounds",
        data: playerDRB,
...
export default TopReboundsDetailedChartTotals;
